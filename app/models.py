...
class User(UserMixin, db.Model):
    ...
    #reservations = db.relationship('Weeks', backref='mieter', lazy='dynamic')
...
class Weeks(db.Model):
    ...
    def __repr__(self):
        return '<Weeks {} date_begin {} date_end {} res. für user.id {}>' \
        	.format(self.id, self.date_begin, self.date_end, self.user_id) 